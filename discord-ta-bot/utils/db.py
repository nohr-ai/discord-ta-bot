...
async def set_field(db_name:str, guild_id: int, field: str, value: Any,upsert=True) -> None:
    """
...
async def set_role_message(db_name:str,
...
async def set_guild_groups(db_name: str,guild_id: int, groups: Optional[list[Group]]=None) -> None:
    '''
...
async def set_persistent_text_channels(db_name: str, guild_id: int, text_channels: list[int] = [], upsert = True) -> None:
    '''
...
async def set_persistent_voice_channels(db_name: str, guild_id: int, voice_channels: list[int] = []) -> None:
    '''
